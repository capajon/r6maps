  ...
  var terms = {
    ...
    mapRooms: {
      ...
      club: {
        ...
        centralSubroof: 'Toit central<br/>à mi-hauteur',
        ...
        CCTVRoom: 'Salle de surveillance',
      ...
      consulate: {
        ...
        serviceStairs: 'Escalier de service',
        electicRoom: 'Local<br/>electrique',
        storageRoom: 'Salle de stockage',
        archives: 'Archives',
        ...
        tellers: 'Guichets',
        visaOffice: 'Bureaue des visas',
        visaEntrance: 'Entrée du bureau<br/>des visas',
        ...
        buildingRoof: 'Toit de l\'immeuble'
      },
      hereford: {
        armory: 'Armuererie',
        ...
        rappelTower: 'Terrainvd\'entraînement',
        terrace: 'Terrasse',
      ...
      house: {
        ...
        frontYard: 'Jarin devant la maison',
      ...
      oregon: {
        towerStairs: 'Escalier de la tour',
        boilerRoom: 'Chaufferie',
        electricRoom: 'Local<br/>électrique',
        bunkerEntrance: 'Entrée<br/>du bunker',
        bunker: 'Bunker',
        basementCorridor: 'Couloir du<br/>sous-sol',
        supplyRoom: 'Réserve',
      ...
      plane: {
        ...
        executiveOffice: 'Bureau classe<br/>affaires',
        mainEntrance: 'Entrée principale',
        frontStairs: 'Entrée de service avant',
        pantry: 'Garde-manger',
        kitchen: 'Cuisine',
        executiveHallway: 'Couloir classe affaires',
        executiveBedroom: 'Chambre<br/>classe affaires',
        ...
        cockpitStairs: 'Escalier du cockpit',
      ...
      yacht: {
        ...
        serverRoom: 'Salle des serveurs',
        engineStorage: 'Stockage des moteurs',
