  ...
  var getMapStatsData = function getMapStatsData() {
    ...
    return {
      ...
      winReasons: { // no need for season span verification
        ...
        attackersSurrendered: { name: terms.statsRoundWinReasons.attackersSurrendered, iconCssClass: 'surrendered' },
        bombDeactivated_OneBomb: { name: terms.statsRoundWinReasons.bombDeactivated_OneBomb, iconCssClass: 'bomb-deactivated' },
        bombExploded: { name: terms.statsRoundWinReasons.bombExploded, iconCssClass: 'bomb-exploded' },
        defendersEliminated: { name: terms.statsRoundWinReasons.defendersEliminated, iconCssClass: 'eliminated' },
        defendersKilledHostage: { name: terms.statsRoundWinReasons.defendersKilledHostage, iconCssClass: 'hostage-killed' },
        defendersSurrendered: { name: terms.statsRoundWinReasons.defendersSurrendered, iconCssClass: 'surrendered' },
        defuserDeactivated: { name: terms.statsRoundWinReasons.defuserDeactivated, iconCssClass: 'defuser-deactivated' },
        hostageExtracted: { name: terms.statsRoundWinReasons.hostageExtracted, iconCssClass: 'hostage-rescued' },
        noEnemies: { name: terms.statsRoundWinReasons.noEnemies },
        objectiveCaptured: { name: terms.statsRoundWinReasons.objectiveCaptured, iconCssClass: 'secured' },
        objectiveProtected: { name: terms.statsRoundWinReasons.objectiveProtected, iconCssClass: 'defended' },
        timeExpired: { name: terms.statsRoundWinReasons.timeExpired, iconCssClass: 'time' }
      },
