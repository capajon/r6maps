    ...
    return {
      ...
      favelas: {
        ...
        roomLabels: [
          ...
          { floor: 2, top: 19, left: -126, description: favelasTerms.footballApartment },
          { floor: 1, top: -197, left: -213, description: favelasTerms.armoryRoom },
          { floor: 1, top: 210, left: -163, description: favelasTerms.auntsApartment, veryHardToRead: true },
          { floor: 1, top: 173, left: -61, description: favelasTerms.auntsApartment, veryHardToRead: true },
          { floor: 2, top: 202, left: -46, description: favelasTerms.auntsBedroom, veryHardToRead: true },
          { floor: 2, top: -205, left: -191, description: favelasTerms.growRoom, veryHardToRead: true },
          { floor: 1, top: -60, left: -131, description: favelasTerms.bikersApartment, hardToRead: true },
          { floor: 1, top: 69, left: -162, description: favelasTerms.bikersApartment, veryHardToRead: true },
          { floor: 2, top: -253, left: 95, description: favelasTerms.methLab, veryHardToRead: true },
          { floor: 2, top: -69, left: -249, description: favelasTerms.footballBedroom },
          { floor: 2, top: 85, left: -321, description: favelasTerms.footballOffice, hardToRead: true },
          { floor: 1, top: 44, left: -346, description: favelasTerms.bikersBedroom },
          ...
          { floor: 2, top: 303, left: -63, description: favelasTerms.kidsRoom, hardToRead: true },
          { floor: 2, top: 223, left: -233, description: favelasTerms.mainStairs, hardToRead: true },
          { floor: 3, top: 223, left: -233, description: favelasTerms.mainStairs, hardToRead: true },
          { floor: 1, top: 223, left: -233, description: favelasTerms.mainStairs, hardToRead: true },
          { floor: 1, top: 86, left: -243, description: favelasTerms.stairHall },
