...
(function(pagecode) { //eslint-disable-line wrap-iife
  ...
  $(function() { // equivanelt to $(document).ready() - but a bit faster
    var categoryKeys = [],
      ...
      translatedTerms = [
        R6MapsCommonLangTerms.terms,
        R6MapsCommonLangTermsGerman.terms,
        R6MapsCommonLangTermsFrench.terms,
        R6MapsCommonLangTermsKorean.terms,
        R6MapsCommonLangTermsPortBrazil.terms,
        R6MapsCommonLangTermsRussian.terms,
        R6MapsCommonLangTermsJapanese.terms,
        R6MapsCommonLangTermsSimplifiedChinese.terms,
        R6MapsCommonLangTermsMongolian.terms,
        R6MapsCommonLangTermsSpanish.terms,
        R6MapsCommonLangTermsPolish.terms
      ];
