  ...
  var name = 'ja',
    terms = {
      general: {
        ...
        languageHeader: '言語',
        optionsHeader: '設定',
        labelLosOpacity: 'カメラ視界の透明度',
        labelPercent: '{int}%',
        labelLosDefault: '(Default)',
        labelLos105: '(あれ?)',
        labelLos110: '(そんなばかな！）',
        labelRoomLabelStyle: '部屋名の文字スタイル',
        labelNumberFloorsToDisplay: '階層を選択',
        lockPanning: 'パンニング解除',
        lockZooming: 'ズーミング解除',
        fullScreen: '全画面',
        enableScreenshots: 'スクリーンショットの許可',
        contributions: '寄付',
        supportSiteNote: 'このサイトをサポートしたい方は寄付ボタンをクリックしてください',
      ...
      roomLabelStyles: {
        ...
        Light: '明るい(標準)',
        DarkAndLarge: '大きくて暗い',
        LightAndLarge: '大きくて明るい',
        DarkAndSmall: '小さくて暗い',
        LightAndSmall: '小さくて明るい',
        DisplayNone: '表示しない'
      },
      floorDisplayOptions: {
        one: '1画面',
      ...
      legend: {
        ...
        droneTunnels: 'ドローンの入り口',
        objectives: '目標',
        insertionPoints: '出現地点',
        securityCameras: '監視カメラ',
        skylights: '天窓',
        onFloorAboveOrBelow: '上か下の階がある',
