...
var R6MapsCommonLangTermsMongolian = (function(R6MapsCommonLangTerms, undefined) {
  var name = 'mn',
    terms = {
      general: {
      ...
      mapRooms: {
        ...
        kafe: {
          spawnRiverDocks: 'Голын эрэг',
          spawnChristmasMarket: 'Баярын яармаг',
          spawnPark: 'Цэцэрлэг',
          laundryRoom: 'Угаалгын<br/>өрөө',
          frontStairs: 'Урд<br/>шат',
          bakery: 'Талхны газар',
          bakeryKitchen: 'Талхчны<br/>гал зуух',
          kitchenPrep: 'Гал зуухны<br/>бэлтгэл',
          kitchenGrill: 'Гал зуух',
          kitchenPickUp: 'Гал зуухны<br/>хаалга',
          coldRoom: 'Хүйтэн өрөө',
          diningRoom: 'Хоолны өрөө',
          backStairs: 'Арын<br/>шат',
          coldRoomCorridor: 'Хүйтэн<br/>өрөөний<br/>коридор',
          VIPSection: 'VIP<br/>хэсэг',
          barStairs: 'Баарны<br/>шат',
          storage: 'Агуулах',
          museumEntrance: 'Музейн<br/>орц',
          miningRoom: 'Уурхайн өрөө',
          trainMuseum: 'Галт тэрэгний музей',
          pillarDiningRoom: 'Баганатай хоолны өрөө',
          ...
          washroomCorridor: 'Бие засахын коридор',
          ...
          backAlley: 'Арын гудам',
          garrage: 'Гараж',
          parkAlley: 'Цэцэрлэгийн<br/>гудам'
        },
        oregon: {
