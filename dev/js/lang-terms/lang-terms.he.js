  ...
  var name = 'he',
    terms = {
      ...
      mapRooms: {
        ...
        hereford: {
          spawnTrainingCourse: 'מסלול אימונים',
          spawnParking: 'חניון',
          spawnShootingRange: 'מטווח',
          armory: 'נשקייה',
          lockers: 'לוקרים',
          corridor: 'מסדרון',
          mainStairs: 'מדרגות</br>ראשיות',
          maintenanceArea: 'אזור</br>תחזוקה',
          briefingRoom: 'חדר</br>תדרוך',
          basementEntrance: 'כניסת</br>מרתף',
          garage: 'מוסך',
          TVRoom: 'חדר</br>טלוויזיה',
          garageCorridor: 'מסדרון מוסך',
          kitchen: 'מטבח',
          corridor1: 'מסדרון</br>אחד',
          diningRoom: 'חדר</br>אוכל',
          pianoLounge: 'טרקלין פסנתר',
          office: 'משרד',
          masterBedroom: 'חדר שינה ראשי',
          backAccess: 'גישה</br>אחורית',
          laundryRoom: 'חדר</br>כביסה',
          bathroom: 'שירותים',
          kidsBedroom: 'חדר</br>ילדים',
          ballisticMatDepot: 'מחסן שטיחים</br>בליסטיים',
          storage: 'אחסון',
          storageCorridor: 'מסדרון</br>אחסון',
          dummyDepot: 'מחסן בובות',
          workshop: 'סדנה',
          shootingRangeEastEntrance: 'מטווח</br>כניסה מזרחית',
          shootingRangeWestEntrance: 'מטווח</br>כניסה מערבית',
          tireSetting: 'גדר צמיגים',
          observationRamp: 'רמפת תצפית',
          barracks: 'צריפים',
          busBackAlley: 'סמטת חניון</br>אוטובוסים',
          rappelTower: 'מגדל</br>סנפלינג',
          terrace: 'מרפסת',
          frontAccess: 'גישה קדמית',
          chapelGate: 'שער קפלה',
          forkliftArea: 'אזור</br>מלגזות',
          sideStairsAlley: 'סמטת</br>מדרגות</br>צדדיות',
          sideStairs: 'מדרגות</br>צדדיות',
          garageTop: 'גג מוסך',
          rooftop: 'גג',
          parkingEntrance: 'כניסה לחניה'
        },
        house: {
          spawnConstructionSite: 'אתר בנייה',
        ...
        kafe: {
          spawnRiverDocks: 'רציפי הנהר',
          spawnChristmasMarket: 'שוק חג המולד',
          spawnPark: 'פארק',
          laundryRoom: 'חדר<br/>כביסה',
          frontStairs: 'מדרגות<br/>קדמיות',
          bakery: 'מאפיה',
          bakeryKitchen: 'מטבח<br/>מאפיה',
          kitchenPrep: 'מטבח<br/>הכנה',
          kitchenGrill: 'גריל מטבח',
          kitchenPickUp: 'מעבר<br/>מטבח',
          coldRoom: 'מקרר',
          diningRoom: 'חדר אוכל',
          backStairs: 'מדרגות<br/>אחוריות',
          coldRoomCorridor: 'מסדרון<br/>קירור',
          VIPSection: 'אזור אח"מים',
          barStairs: 'מדרגות<br/>הבר',
          storage: 'אחסון',
          museumEntrance: 'כניסה<br/>למוזיאון',
          miningRoom: 'חדר כריה',
          trainMuseum: 'מוזיאון רכבות',
          pillarDiningRoom: 'חדר אוכל<br/>עמודים',
          ...
          washrooms: 'שירותים',
          washroomCorridor: 'מסדרון<br/>שירותים',
