  ...
  var name = 'fr',
    terms = {
      ...
      mapRooms: {
        ...
        themepark: {
          arcadeRoof: 'Toit salle<br/>d\'arcade',
          arcadeEntrance: 'Entrée salle<br/>d\'arcade',
          arcadeStairs: 'Escalier salle<br/>d\'arcade',
          arcadeToilet: 'Toilettes<br/>salle d\'arcade',
          barrelRoom: 'Salle des<br/>tonneaux',
          backAlley: 'Ruelle',
          bumperCars: 'Auto-<br/>tamponneuses',
          bunk: 'Dortoir',
          bunkToilet: 'Toilettes du<br/>dortoir',
          cafe: 'Café',
          cafeCorridor: 'Couloir du café',
          cafeStairs: 'Escalier<br/>du café',
          cafeTerrace: 'Terrasse<br/>du café',
          cashStash: 'Réserve d\'argent',
          coffinRoom: 'Salle des cercueils',
          controlRoom: 'Salle de<br/>commande',
          crypt: 'Crypte',
          dayCare: 'Garderie',
          drugLab: 'Laboratoire<br/>de drogue',
          drugStorage: 'Réserve<br/>de drogue',
          executionRoom: 'Salle d\'exécution',
          fuelStorage: 'Stockage carburant',
          gallery: 'Galerie',
          gargoyle: 'Gargouille',
          gargoyleStorage: 'Réserve<br/>gargouilles',
          guestInfo: 'Point info<br/>visiteurs',
          hauntedBalcony: 'Balcon<br/>hanté',
          hauntedDining: 'Salle à manger<br/>hantée',
          hauntedEntrance: 'Entrée<br/>hantée',
          hauntedRoof: 'Toit<br/>hanté',
          hauntedShop: 'Boutique<br/>hantée',
          hauntedStairs: 'Escalier<br/>hanté',
          initiationRoom: 'Salle<br/>d\initiation',
          jointCorridor: 'Couloir<br/>commun',
          liftCar: 'Wagon<br/>abandonné',
          loadingDeck: 'Quai de<br/>chargement',
          lockerRoom: 'Vestiaires',
          mainEntrance: 'Entrée principale',
          office: 'Bureau',
          officeToilet: 'Toilettes<br/>du bureau',
          palms: 'Palmiers',
          propStorage: 'Réserve accessoires',
          railOverlook: 'Belvé<br/>dère',
          railCorridor: 'Couloir voie ferrée',
          railPlatform: 'Quai',
          railRamp: 'Voie ferrée',
          roboCircuit: 'Circuit robots',
          serviceCorridor: 'Couloir<br/>de service',
          serviceEntry: 'Entrée de<br/>service',
          southExit: 'Sortie<br/>sud',
          sweetShop: 'Confiserie',
          teacups: 'Tasses',
          upperArcade: 'Salle<br/>d\'arcade',
          village: 'Village'
        },
        tower: {
          northRoof: 'Toit nord',
