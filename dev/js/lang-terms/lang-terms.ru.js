    ...
    terms = {
      ...
      mapRooms: {
        ...
        themepark: {
          ...
          bunkToilet: 'Ком. с диваном<br/>Уборная',
          cafe: 'Кафе',
          cafeCorridor: 'Кафе - Коридор',
          cafeStairs: 'Кафе<br/>Лестница',
          cafeTerrace: 'Кафе<br/>Терраса',
          cashStash: 'Хранилище',
          coffinRoom: 'Комната с гробом	',
          controlRoom: 'Диспетчерская',
          crypt: 'Склеп',
          dayCare: 'Ясли',
          drugLab: 'Лаборатория',
          drugStorage: 'Склад<br/>наркотиков',
          executionRoom: 'Комната для казни',
          fuelStorage: 'Склад с топливом',
          gallery: 'Галерея',
          gargoyle: 'Гаргульи',
          gargoyleStorage: 'Гаргульи<br/>Склад',
          guestInfo: 'Объявления',
          hauntedBalcony: 'Дом ужасов<br/>Балкон',
          hauntedDining: 'Дом ужасов<br/>Столовая',
          hauntedEntrance: 'Дом ужасов - Вход',
          hauntedRoof: 'Дом ужасов<br/>Крыша',
          hauntedShop: 'Дом ужасов<br/>Магазин',
          hauntedStairs: 'Дом ужасов<br/>Лестница',
          initiationRoom: 'Комната<br/>посвящения',
          jointCorridor: 'Общий<br/>коридор',
          liftCar: 'Кабина<br/>лифта',
          loadingDeck: 'Зона<br/>погрузки',
          lockerRoom: 'Раздевалка',
          mainEntrance: 'Главный вход',
          office: 'Офис',
          officeToilet: 'Офис<br/>Уборная',
          palms: 'Пальмы',
          propStorage: 'Склад',
          railOverlook: 'Точка<br/>обзора',
          railCorridor: 'Коридор',
          railPlatform: 'Платформа',
          railRamp: 'Рампа',
          roboCircuit: 'Ринг для роботов',
          serviceCorridor: 'Служебный<br/>вход',
          serviceEntry: 'Служебный<br/>вход',
          southExit: 'Выход<br/>Юг',
