  ...
  var name = 'es',
    terms = {
      ...
      mapRooms: {
        ...
        hereford: {
          spawnTrainingCourse: 'Pista de entrenamiento',
          spawnParking: 'Aparcamiento',
          spawnShootingRange: 'Galería de tiro',
          armory: 'Armería',
          lockers: 'Taquillas',
          corridor: 'Pasillo',
          mainStairs: 'Escalera<br/>principal',
          maintenanceArea: 'Zona de<br/>mantenimiento',
          briefingRoom: 'Sala de<br/>informes',
          basementEntrance: 'Entrada al sótano',
          garage: 'Garage',
          TVRoom: 'Sala<br/>de TV',
          garageCorridor: 'Pasillo del garage',
          kitchen: 'Cocina',
          corridor1: 'Pasillo 1',
          diningRoom: 'Comedor',
          pianoLounge: 'Sala de<br/>piano',
          office: 'Oficina',
          masterBedroom: 'Habitación<br/>principal',
          backAccess: 'Acceso<br/>posterior',
          laundryRoom: 'Lavandería',
          bathroom: 'Baño',
          kidsBedroom: 'Cuarto de<br/>los niños',
          ballisticMatDepot: 'Depósito de<br/>mantas antibalas',
          storage: 'Almacén',
          storageCorridor: 'Pasillo<br/>al almacén',
          dummyDepot: 'Deposito<br/>de dummies',
          workshop: 'Taller',
          shootingRangeEastEntrance: 'Acceso este a<br/>galería de tiro',
          shootingRangeWestEntrance: 'Acceso oeste a<br/>galería de tiro',
          tireSetting: 'Montaje de neumaticos',
          observationRamp: 'Rampa de observación',
          barracks: 'Barracones',
          busBackAlley: 'Callejón<br/>trasero<br/>autobús',
          rappelTower: 'Torre<br/>de rapel',
          terrace: 'Terraza',
          frontAccess: 'Acceso frontal',
          chapelGate: 'Puerta de<br/>la capilla',
          forkliftArea: 'Zona de<br/>carretilla elevadora',
          sideStairsAlley: 'Callejón de la<br/>escalera lateral',
          sideStairs: 'Escaleras<br/>laterales',
          garageTop: 'Parte superior<br/>del garage',
          rooftop: 'Tejado',
        ...
        kafe: {
          spawnRiverDocks: 'Embarcadero del río',
          spawnChristmasMarket: 'Mercadillo navideño',
          spawnPark: 'Callejón del parque',
          laundryRoom: 'Sala de<br/>lavandería',
          frontStairs: 'Escalera<br/>frontal',
          bakery: 'Obrador de<br/>pastelería',
          bakeryKitchen: 'Cocina del<br/>obrador',
          kitchenPrep: 'Preparación<br/>de cocina',
          kitchenGrill: 'Parrilla de<br/>la cocina',
          kitchenPickUp: 'Recogida<br/>de la cocina',
          coldRoom: 'Cámara fría',
          diningRoom: 'Comedor',
          backStairs: 'Escalera<br/>trasera',
          coldRoomCorridor: 'Pasillo a la<br/>cámara fría',
          VIPSection: 'Sección<br/>VIP',
          barStairs: 'Escalera<br/>del bar',
          storage: 'Almacén',
          museumEntrance: 'Entrada<br/>al museo',
          miningRoom: 'Sala de minería',
          trainMuseum: 'Museo del tren',
          pillarDiningRoom: 'Comedor de<br/>las columnas',
          ...
          washrooms: 'Lavavos',
          washroomCorridor: 'Pasillo de<br/>los baños',
          ...
          backAlley: 'Callejón trasero',
          garrage: 'Garage',
          parkAlley: 'Callejón<br/>del parque'
        },
        oregon: {
        ...
        themepark: {
          arcadeRoof: 'Tejado de los<br/>recreativos',
          ...
          bunk: 'Camastros',
          bunkToilet: 'Aseos del<br/>dormitorio',
          cafe: 'Café',
          ...
          coffinRoom: 'Sala de<br/>ataudes',
          controlRoom: 'Sala de<br/>control',
          crypt: 'Cripta',
          dayCare: 'Guardería',
          drugLab: 'Laboratorio<br/>de drogas',
          drugStorage: 'Almacén<br/>de drogas',
          executionRoom: 'Sala de<br/>ejecución',
          fuelStorage: 'Depósito de<br/>combustible',
          gallery: 'Galería',
          gargoyle: 'Gargolas',
          gargoyleStorage: 'Almacén<br/>con armas',
          guestInfo: 'Información<br/>para visitantes',
          hauntedBalcony: 'Terraza<br/>encantada',
          hauntedDining: 'Comedor<br/>encantado',
          hauntedEntrance: 'Entrada<br/>encantada',
          hauntedRoof: 'Tejado<br/>encantado',
          hauntedShop: 'Tienda<br/>encantada',
          hauntedStairs: 'Escaleras<br/>encantadas',
          initiationRoom: 'Sala de<br/>iniciación',
          jointCorridor: 'Pasillo general',
          liftCar: 'Vagón del<br/>teleférico',
          loadingDeck: 'Muelle<br/>de carga',
          lockerRoom: 'Área de<br/>taquillas',
          mainEntrance: 'Entrada principal',
          office: 'Oficina',
          officeToilet: 'Aseos de<br/>la oficina',
          palms: 'Palmeras',
          propStorage: 'Almacén de<br/>materiales',
          railOverlook: 'Mirador del tren',
          railCorridor: 'Pasillo del tren',
          railPlatform: 'Andén<br/>del tren',
          railRamp: 'Rampa del tren',
          roboCircuit: 'Circuito de robots',
          serviceCorridor: 'Pasillo de<br/>servicio',
          serviceEntry: 'Entrada de<br/>servicio',
          southExit: 'Salida<br/>sur',
